import { Card, CardId, ClientSE, ListId, UserId } from '@mosaiq/terrazzo-common';
...
export const updateCardField = async (sockCtx: SocketContextType, id: CardId, partial: Partial<Card>) => {
