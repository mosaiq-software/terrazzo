...
export class SocketIOProvider extends Observable<string> {
    ...
    constructor(url: string, roomName: string, doc: Y.Doc = new Y.Doc(), { autoConnect = true, awareness = new AwarenessProtocol.Awareness(doc), resyncInterval = -1, disableBc = false, auth = {} }: ProviderConfiguration, socketIoOptions: Partial<ManagerOptions & SocketOptions> | undefined = undefined) {
        super();
