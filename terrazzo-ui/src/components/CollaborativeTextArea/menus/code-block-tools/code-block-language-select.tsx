...
export const CodeBlockLanguageSelect = ({ languages = [], className, onLanguageChange, onPointerDownSelect, onSelectChange }: CodeBlockLanguageSelectProps): JSX.Element | null => {
    ...
    const languageOptions = useMemo(() => {
        ...
        return uniqueBy(allLanguages, (lang) => lang.displayName).sort((a, b) => a.displayName.localeCompare(b.displayName));
